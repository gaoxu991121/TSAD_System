...
from Models.Layers.ChannelDeAttention import ChannelDeAttention
...
class CHANNELDE(BaseModel):
    """
    依据通道的依赖关系进行重建
    """

    def __init__(self, config):
        super(CHANNELDE, self).__init__()
        self.config = config
        ...
        self.attention = ChannelDeAttention(input_size=self.input_size,seq_length=self.window_size,hidden_size=self.hidden_size,predict_length=self.predict_length)
